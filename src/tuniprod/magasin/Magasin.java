...
import tuniprod.employe.Employe;
...
public class Magasin {
    ...
    public void afficheSalaire(Employe[] emps){
        double somme = 0;
                for (Employe e : emps){
                    somme= somme + e.getSalaire();
                }
    }
    public void primeResponsable(Employe[] emps){
        for (Employe e : emps){
            if (e instanceof Responsable){
                System.out.println(((Responsable) e).getPrime());
            }
        }
    }
    ...
    public String toString() {
        return "Magasin{" +
                ...
                ", CAPACITE_MAX_EMPLOYE=" + CAPACITE_MAX_EMPLOYE +
                ", id=" + id +
                ", libelle='" + libelle + '\'' +
                ", adresse='" + adresse + '\'' +
